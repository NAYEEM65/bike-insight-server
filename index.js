...
async function run() {
    try {
        ...
        const bikesCategoryCollection = client.db('bikeInsight').collection('bikesCategory');
        ...
        app.put('/users/:email', async (req, res) => {
            ...
            const result = await userCollection.updateOne(query, updateUserReq, options);
            res.send(result);
        });
        ...
        app.patch('/products/:id', async (req, res) => {
            ...
            const result = await productsCollection.updateOne(query, updateAdvertiseItem);
            res.send(result);
